 ...
 * Function: 二维码扫描界面
 * Desc:
 * Reference: https://github.com/jqn/AC-QRCode-RN/blob/master/lib/QRScanner.js
 */
import React, { PureComponent } from 'react';
import { ActivityIndicator, StyleSheet, View, Animated, Easing, Text, Image } from 'react-native';
...
class QRScannerRectView extends PureComponent<Props> {
  static defaultProps = {
    maskColor: '#0000004D',
    cornerColor: '#22ff00',
    borderColor: '#000000',
    ...
    scanBarHeight: 1.5,
    scanBarMargin: 6,
    hintText: 'Please put the qr code inside the rectangle.',
